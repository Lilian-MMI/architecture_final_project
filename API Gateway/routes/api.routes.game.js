...
module.exports = (app) => {
    ...
    app.get('/api/game/quizzs', function (req, res) {
    ...
    app.get('/api/game/quizz/:quizzId', function (req, res) {

        let id = req.params.quizzId;
        console.log(id)
        axios.get({
            // method: 'get',
    ...
    app.post('/api/game/quizz/answer', function (req, res) {
